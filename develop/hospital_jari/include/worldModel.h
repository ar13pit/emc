...
public:
    ...
    std::vector<Exit_map> get_allDetectedExits();

    Point get_closestPointWall();
    Position get_globalPosition();                     // Renamed from     Point getCurrentPosition();
    ...
    void set_globalPosition(Position updatedGlobalPosition);
